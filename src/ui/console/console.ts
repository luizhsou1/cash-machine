...
const configAvailablesMoneys = async (): Promise<void> => {
  console.clear()
  console.log('💸💸💸 CONFIGURAR CÉDULAS DISPONÍVEIS 💸💸💸\n')
  ...
  try {
    ...
    console.log('🟢 Cédulas de dinheiro disponíveis atualizadas com sucesso!')
  } catch (err) {
    await prompt([{
      type: 'confirm',
      name: 'again',
...
export const initConsole = async (): Promise<void> => {
  ...
  do {
    console.clear()
    console.log('💰💰💰 SISTEMA DE CAIXA ELETRÔNICO 💰💰💰\n')
